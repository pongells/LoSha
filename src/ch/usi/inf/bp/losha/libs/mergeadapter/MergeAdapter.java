package ch.usi.inf.bp.losha.libs.mergeadapter;
...
public class MergeAdapter extends BaseAdapter implements SectionIndexer {
	...
	private static class EnabledSackAdapter extends SackOfViewsAdapter {
		public EnabledSackAdapter(final List<View> views) {
			super(views);
		}
	 ...
	 */
	public void addAdapter(final ListAdapter adapter) {
		pieces.add(adapter);
	 ...
	 */
	public void addView(final View view, final boolean enabled) {
	 ...
	 */
	public void addViews(final List<View> views) {
	 ...
	 *            false if views are disabled, true if enabled
	 */
	public void addViews(final List<View> views, final boolean enabled) {
		if (enabled) {
	...
	public int getPositionForSection(int section) {
		...
		for (final ListAdapter piece : pieces) {
			if (piece instanceof SectionIndexer) {
				final Object[] sections = ((SectionIndexer) piece)
				.getSections();
				int numSections = 0;
	...
	public Object[] getSections() {
		final ArrayList<Object> sections = new ArrayList<Object>();

		for (final ListAdapter piece : pieces) {
			if (piece instanceof SectionIndexer) {
				final Object[] curSections = ((SectionIndexer) piece)
				.getSections();

				if (curSections != null) {
					for (final Object section : curSections) {
